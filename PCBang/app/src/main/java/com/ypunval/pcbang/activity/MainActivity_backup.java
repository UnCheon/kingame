...
import com.ypunval.pcbang.update.UpdateHelper;
...
public class MainActivity_backup extends BaseRealmActivity {
    ...
    private void setSearchView() {
        ...
        mSearchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                Intent intent = new Intent(MainActivity_backup.this, ResultActivity.class);
